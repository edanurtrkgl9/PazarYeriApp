...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private void createUser() {
        ...
        if(TextUtils.isEmpty(userName)){
            Toast.makeText(this,"İsim yazmadınız.",Toast.LENGTH_SHORT).show();
            return;
        }
        
        if (TextUtils.isEmpty(userEmail)){
            Toast.makeText(this, "Email yazmadınız.", Toast.LENGTH_SHORT).show();
            return;
        }
        
        if (TextUtils.isEmpty(userPassword)){
            Toast.makeText(this, "Şifre yazmadınız.", Toast.LENGTH_SHORT).show();
            return;
        }
        
        if (userPassword.length() < 6){
            Toast.makeText(this, "Şifre 6 karakterden uzun olmalı.", Toast.LENGTH_SHORT).show();
            return;
        }
